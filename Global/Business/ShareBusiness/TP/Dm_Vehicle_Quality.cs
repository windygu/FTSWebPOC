...
{
        [Serializable]
    public class Dm_Vehicle_Quality : IHead
    {
        ...
        private string mVehicle_Quality_Name;
        public string Vehicle_Quality_Name
        {
            get { return mVehicle_Quality_Name; }
            set { mVehicle_Quality_Name = value; }
        }
