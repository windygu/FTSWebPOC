...
{
    [Serializable]
    public class Dm_Route_Point_Class : IHead
    {
        ...
        private string mRoute_Point_Class_Name;
        public string Route_Point_Class_Name
        {
            get { return mRoute_Point_Class_Name; }
            set { mRoute_Point_Class_Name = value; }
        }
