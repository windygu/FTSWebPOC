...
namespace FTS.Global.Business.HotelBusiness.Hotel
{
    ...
    public class Ht_Shift : IHead
    {
        ...
        private int mShift_Hour;
        public int Shift_Hour
        {
            get { return mShift_Hour; }
            set { mShift_Hour = value; }
        }
        private int mShift_Minute;
        public int Shift_Minute
        {
            get { return mShift_Minute; }
            set { mShift_Minute = value; }
        }
