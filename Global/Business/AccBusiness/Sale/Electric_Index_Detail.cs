...
{
    [Serializable]
    public class Electric_Index_Detail : IHead
    {
        DataState mDataState = DataState.NONE;
        object mIdValue = string.Empty;
        public Electric_Index_Detail()
        {
        }
        ...
        private Int16 mIs_3pha;
        public Int16 Is_3pha
        {
            get { return mIs_3pha; }
            set { mIs_3pha = value; }
        }
        ...
        private decimal mResult;
        public decimal Result
        {
            get { return mResult; }
            set { mResult = value; }
        }
        private decimal mMultiplier;
