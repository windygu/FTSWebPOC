...
namespace FTS.BaseUI.Controls {
    public partial class FTSListView : ListView {
        ...
        protected override void OnHandleCreated(EventArgs e) {
            ...
            this.hdr_contrl = new ListViewFilterHeader(this, this.hdr_filter, this.srt_column, this.srt_sorder);
        }
        ...
        protected override void OnHandleDestroyed(EventArgs e) {
            ...
            if (this.hdr_contrl != null) {
                this.hdr_contrl.ReleaseHandle();
                this.hdr_contrl = null;
            }
        ...
        protected override void WndProc(ref Message m) {
            ...
            switch (m.Msg) {
                ...
                case (int) W32_WM.WM_ERASEBKGND:
                    ...
                    if (this.col_shaded && (this.hdr_contrl != null) && (this.View == View.Details)) {
                        // get the 'fake' size information from the header
                        // column.  this is only the Width and Left (as Height).
                        Size z = this.hdr_contrl.SizeInfo[this.srt_column];
                        ...
                        g.FillRectangle(new SolidBrush(this.col_scolor), z.Height, this.Top, z.Width, this.Height);
                    }
                    break;
                ...
                case (int) W32_WM.WM_NOTIFY:
                    ...
                    if ((this.hdr_contrl != null) && (h1.hdr.hwndFrom == this.hdr_contrl.Handle)) {
                ...
                case (int) W32_OCM.OCM_NOTIFY:
                    ...
                    if (h2.hdr.hwndFrom == this.Handle) {
                        ...
                        switch (h2.hdr.code) {
                            ...
                            case (int) W32_NM.NM_CUSTOMDRAW:
                                ...
                                m.Result = (IntPtr) this.NotifyCustomDraw(d);
                                break;
                        }
                    }
                    break;
        ...
        private W32_CDRF NotifyCustomDraw(NMLVCUSTOMDRAW d) {
            ...
            switch (d.nmcd.dwDrawStage) {
                ...
                case (int) W32_CDDS.CDDS_PREPAINT:
                    if (this.col_shaded && (this.View == View.Details)) {
                ...
                case (int) W32_CDDS.CDDS_SUBITEMPREPAINT:
                    ...
                    if (d.nmcd.dwItemSpec < this.Items.Count) {
                        ...
                        if (d.iSubItem == 0) {
                            i.BackColor = (d.iSubItem == this.srt_column) ? this.col_scolor : this.BackColor;
                        }

                            // ensure that the subitem exits before changing it
                        else if ((d.iSubItem < i.SubItems.Count) && (i.SubItems[d.iSubItem] != null)) {
                            i.SubItems[d.iSubItem].BackColor = (d.iSubItem == this.srt_column)
                                                                   ? this.col_scolor
                                                                   : this.BackColor;
                        }
                    }
        ...
        private void NotifyHeaderMessage(NMHEADER h) {
            ...
            switch (h.hdr.code) {
                ...
                case (int) W32_HDN.HDN_ITEMCLICKW:
                    this.hdr_contrl.SortColumn = this.srt_column = h.iItem;
                    this.srt_sorder = this.hdr_contrl.SortOrder;
                    this.srt_datype = this.hdr_contrl.DataType[this.srt_column];
                    this.Sort();
                    break;
                ...
                case (int) W32_HDN.HDN_FILTERBTNCLICK:
                    this.mnu_column = h.iItem;
                    this.mnu_filter.Show(this, this.PointToClient(MousePosition));
                    break;
                ...
                case (int) W32_HDN.HDN_FILTERCHANGE:
                    ...
                    if (h.iItem < 0) {
                        this.itm_filtrs.Clear();
                    }

                        // if we are filtered this is a real filter data change
                    else if (this.hdr_filter) {
                        this.FilterBuild(h.iItem);
                    }
        ...
        private void FilterBuild(int c) {
            ...
            foreach (LVFFilter f in this.itm_filtrs) {
                if (f.Column == c) {
                    this.itm_filtrs.Remove(f);
                    break;
                }
            }
            // get the filter text for this column from the header
            string s = this.hdr_contrl.Filter[c].Trim();
            ...
            if (s.Length > 0) {
                ...
                f.Type = this.hdr_contrl.DataType[c];
        ...
        private bool FilterCheck(ListViewItem i, LVFFilter f) {
            ...
            int r = (this.flt_ignore)
                        ? this.CompareData(this.ItemText(i, f.Column).ToLower(), f.Text.ToLower(), f.Type, true)
                        : this.CompareData(this.ItemText(i, f.Column), f.Text, f.Type, true);
        ...
        private void FilterUpdate() {
            ...
            if (this.itm_filtrs.Count != 0) {
                ...
                for (int i = 0; i < this.Items.Count; ++i) {
                    ...
                    foreach (LVFFilter f in this.itm_filtrs) {
                        if (!this.FilterCheck(l, f)) {
                            this.itm_holder.Add(l);
                ...
                for (int i = 0; i < this.itm_filtrd.Count; ++i) {
                    // get the object as a listviewitem
                    l = (ListViewItem) this.itm_filtrd[i];
                ...
                c = (this.itm_filtrd.Count > 0);
                // put all filtered items back and clear the list
                foreach (ListViewItem l in this.itm_filtrd) {
                    this.Items.Add(l);
                }
                this.itm_filtrd.Clear();
            }
        ...
        private void MenuItemClick(object sender, EventArgs e) {
            ...
            if (sender == this.mnu_clearf) {
                this.hdr_contrl.Filter[this.mnu_column] = string.Empty;
            }

                // 'Ignore case', toggle the flag
            else if (sender == this.mnu_ignore) {
                this.flt_ignore = !this.flt_ignore;
            }

                // 'String', set the datatype comparison
            else if (sender == this.mnu_strflt) {
                this.hdr_contrl.DataType[this.mnu_column] = LVFDataType.String;
            }

                // 'Number', set the datatype comparison
            else if (sender == this.mnu_nbrflt) {
                this.hdr_contrl.DataType[this.mnu_column] = LVFDataType.Number;
            }

                // 'Date', set the datatype comparison
            else if (sender == this.mnu_datflt) {
                this.hdr_contrl.DataType[this.mnu_column] = LVFDataType.Date;
            }

                // 'Left', set the alignment
            else if (sender == this.mnu_alignl) {
                this.hdr_contrl.Alignment[this.mnu_column] = HorizontalAlignment.Left;
            }

                // 'Right', set the alignment
            else if (sender == this.mnu_alignr) {
                this.hdr_contrl.Alignment[this.mnu_column] = HorizontalAlignment.Right;
            }

                // 'Center', set the alignment
            else if (sender == this.mnu_alignc) {
                this.hdr_contrl.Alignment[this.mnu_column] = HorizontalAlignment.Center;
            }
            ...
            this.FilterBuild(this.mnu_column);
            ...
            if (((MenuItem) sender).Parent == this.mnu_alignt) {
                this.Invalidate();
            }
        }
        ...
        private void ContextMenuPopup(object sender, EventArgs e) {
            ...
            switch (this.hdr_contrl.DataType[this.mnu_column]) {
                case LVFDataType.Date:
                    this.mnu_strflt.Checked = false;
                    this.mnu_nbrflt.Checked = false;
                    this.mnu_datflt.Checked = true;
                    break;
                case LVFDataType.Number:
                    this.mnu_strflt.Checked = false;
                    this.mnu_nbrflt.Checked = true;
                    this.mnu_datflt.Checked = false;
                    break;
                default:
                    this.mnu_strflt.Checked = true;
                    this.mnu_nbrflt.Checked = false;
                    this.mnu_datflt.Checked = false;
                    break;
            }
            // disable the checked DataType menu item
            this.mnu_strflt.Enabled = !this.mnu_strflt.Checked;
            this.mnu_nbrflt.Enabled = !this.mnu_nbrflt.Checked;
            this.mnu_datflt.Enabled = !this.mnu_datflt.Checked;
            // also set the current alignment
            switch (this.hdr_contrl.Alignment[this.mnu_column]) {
                case HorizontalAlignment.Center:
                    this.mnu_alignl.Checked = false;
                    this.mnu_alignr.Checked = false;
                    this.mnu_alignc.Checked = true;
                    break;
                case HorizontalAlignment.Right:
                    this.mnu_alignl.Checked = false;
                    this.mnu_alignr.Checked = true;
                    this.mnu_alignc.Checked = false;
                    break;
                default:
                    this.mnu_alignl.Checked = true;
                    this.mnu_alignr.Checked = false;
                    this.mnu_alignc.Checked = false;
                    break;
            }
            // disable the checked DataType menu item
            this.mnu_alignl.Enabled = !this.mnu_alignl.Checked;
            this.mnu_alignr.Enabled = !this.mnu_alignr.Checked;
            this.mnu_alignc.Enabled = !this.mnu_alignc.Checked;
            // set the checked state of the case insensitive
            this.mnu_ignore.Checked = this.flt_ignore;
        }
        ...
        internal int CompareData(string s1, string s2, LVFDataType type, bool size) {
            ...
            switch (type) {
                ...
                case LVFDataType.Number:
                    try {
                        this.cmp_float1 = float.Parse(s1);
                    } catch {
                        this.cmp_float1 = float.MaxValue;
                    }
                    ;
                    try {
                        this.cmp_float2 = float.Parse(s2);
                    } catch {
                        this.cmp_float2 = float.MaxValue;
                    }
                    ;
                    return this.cmp_float1.CompareTo(this.cmp_float2);
                    // date also requires a parse
                case LVFDataType.Date:
                    try {
                        this.cmp_datim1 = DateTime.Parse(s1);
                    } catch {
                        this.cmp_datim1 = DateTime.MaxValue;
                    }
                    ;
                    try {
                        this.cmp_datim2 = DateTime.Parse(s2);
                    } catch {
                        this.cmp_datim2 = DateTime.MaxValue;
                    }
                    ;
                    return DateTime.Compare(this.cmp_datim1, this.cmp_datim2);
        ...
        /// </summary>
        [Description(
            "The ListViewFilterHeader instance for access to " +
            "the Names, Sizes, DataType, and Filter entries by column."), Browsable(false)]
        public ListViewFilterHeader Header {
            get { return this.hdr_contrl; }
        }

        [Description("The LVFDataType associated with the current column " + "that is being sorted."), Browsable(false)]
        public LVFDataType SortType {
            get { return this.srt_datype; }
        }
        ...
        /// ShadeColor property...
        /// </summary>
        [Description("In Details mode, the header will display filter controls."), Category("Behavior"),
         DefaultValue(false)]
        public bool Filtered {
            ...
            set {
                if (this.hdr_filter != value) {
                    ...
                    if (this.hdr_contrl != null) {
                        this.hdr_contrl.Filtered = this.hdr_filter;
                    }
                    this.Refresh();
                }
            }
        ...
        [Description("Treat filter strings case-insensitive for comparison."), Category("Behavior"), DefaultValue(false)
        ]
        public bool IgnoreCase {
            get { return this.flt_ignore; }
            set {
                if (this.flt_ignore != value) {
                    this.flt_ignore = value;
                    this.FilterUpdate();
                }
            }
        }

        [Description("In Details mode, the sorted column will be shaded."), Category("Appearance"), DefaultValue(true)]
        public bool Shaded {
            get { return this.col_shaded; }
            set {
                if (this.col_shaded != value) {
                    this.col_shaded = value;
                    this.Refresh();
                }
            }
        }
        ...
        public Color ShadeColor {
            get { return this.col_scolor; }
            set {
                this.col_scolor = value;
                this.Refresh();
            }
        }

        [Description("The sorted column when in details mode."), Category("Behavior"), DefaultValue(0)]
        public int SortColumn {
            get { return this.srt_column; }
            set {
                if ((this.srt_column != value) && (value < this.Columns.Count) && (this.hdr_contrl != null)) {
                    this.srt_column = this.hdr_contrl.SortColumn = value;
        ...
        [Description("The order of the current sort. True is ascending."), Category("Behavior"), DefaultValue(false),
         Browsable(false)]
        public bool SortOrder {
            get { return this.srt_sorder; }
            set {
                if ((this.srt_sorder != value) && (this.hdr_contrl != null)) {
                    this.srt_sorder = this.hdr_contrl.SortOrder = value;
                    if (this.View == View.Details) {
                        this.Sort();
                    }
                }
    ...
    /// for use with a FTSListView control in this assembly.  The
    ...
    public class ListViewFilterHeader : NativeWindow {
        ...
        private readonly FTSListView hdr_lstvew; // owning listview control
        ...
        public ListViewFilterHeader(FTSListView listview, bool filtered, int column, bool order) {
            // save the listview instance and set initial properties
            this.hdr_lstvew = listview;
            this.hdr_sorder = order;
            this.hdr_column = column;
            // set the handle to this control.  the first dialog item
            // for a listview is this header control...
            this.AssignHandle(GetDlgItem(this.hdr_lstvew.Handle, 0));
            // create the collection properties
            this.DataType = new ColumnDataTypeCollection(this);
            this.Filter = new ColumnFilterCollection(this);
        ...
        private void ChangeFiltered() {
            ...
            int style = GetWindowLong(this.Handle, W32_GWL.GWL_STYLE);
            ...
            if (((style & HDS_FILTR) != 0) != this.hdr_filter) {
                ...
                SetWindowLong(this.Handle, W32_GWL.GWL_STYLE, style);
                ...
                SendMessage(this.Handle, W32_HDM.HDM_GETITEMW, 0, ref this.hdr_hditem);
                this.hdr_hditem.cxy += (this.hdr_filter) ? 1 : -1;
                SendMessage(this.Handle, W32_HDM.HDM_SETITEMW, 0, ref this.hdr_hditem);
            }
            // it can't hurt to set the filter timeout limit to .5 seconds
            SendMessage(this.Handle, W32_HDM.HDM_SETFILTERCHANGETIMEOUT, 0, 500);
            // it is necessary to clear all filters which will cause a 
            // notification be sent to the ListView with -1 column.
            SendMessage(this.Handle, W32_HDM.HDM_CLEARFILTER, -1, 0);
        }
        ...
        private void ChangeSort(int c) {
            ...
            this.hdr_hditem.mask = W32_HDI.HDI_FORMAT;
            // turn off the sorted flag for all but the current column
            int i = SendMessage(this.Handle, W32_HDM.HDM_GETITEMCOUNT, 0, 0);
            while (i-- > 0) {
                // get the item information (HDITEM structure)
                SendMessage(this.Handle, W32_HDM.HDM_GETITEMW, i, ref this.hdr_hditem);
                // is this the column we are to flag as sorted
                if (i == this.hdr_column) {
                    // set true when the current mode is down or none set yet
                    this.hdr_sorder = ((this.hdr_hditem.fmt & W32_HDF.HDF_SORTUP) == 0);
                    // set the new sort mode in the format
                    this.hdr_hditem.fmt &= W32_HDF.HDF_NOSORT;
                    this.hdr_hditem.fmt |= (this.hdr_sorder) ? W32_HDF.HDF_SORTUP : W32_HDF.HDF_SORTDOWN;
                }

                    // not the sort column, turn off any existing sort flag
                else if ((this.hdr_hditem.fmt & W32_HDF.HDF_SORTED) != 0) {
                    this.hdr_hditem.fmt &= W32_HDF.HDF_NOSORT;
                }
                ...
                SendMessage(this.Handle, W32_HDM.HDM_SETITEMW, i, ref this.hdr_hditem);
            }
            // finally invalidate the listview so that it redraws
            this.hdr_lstvew.Invalidate(this.hdr_lstvew.Bounds);
        }
        ...
        /// </summary>
        public int SortColumn {
            get { return this.hdr_column; }
            set {
                this.hdr_column = value;
                this.ChangeSort(this.hdr_column);
            }
        }
        ...
        /// </summary>
        public bool SortOrder {
            get { return this.hdr_sorder; }
            set {
                if (this.hdr_sorder != value) {
                    this.hdr_sorder = value;
                    this.ChangeSort(this.hdr_column);
                }
            }
        }
        ...
        public class ColumnAlignmentCollection {
            private readonly ListViewFilterHeader col_hdrctl = null; // owning header control
            ...
            public HorizontalAlignment this[int index] {
                get {
                    ...
                    this.col_hditem.mask = W32_HDI.HDI_FORMAT;
                    SendMessage(this.col_hdrctl.Handle, W32_HDM.HDM_GETITEMW, index, ref this.col_hditem);
                    // return the current setting
                    if ((this.col_hditem.fmt & W32_HDF.HDF_CENTER) != 0) {
                        return HorizontalAlignment.Center;
                    } else if ((this.col_hditem.fmt & W32_HDF.HDF_RIGHT) != 0) {
                ...
                set {
                    ...
                    if (index < this.Count) {
                        ...
                        this.col_hditem.fmt &= W32_HDF.HDF_NOJUSTIFY;
                        // turn on the correct alignment
                        switch (value) {
                            case HorizontalAlignment.Center:
                                this.col_hditem.fmt |= W32_HDF.HDF_CENTER;
                                break;
                            case HorizontalAlignment.Right:
                                this.col_hditem.fmt |= W32_HDF.HDF_RIGHT;
                                break;
                            default:
                                this.col_hditem.fmt |= W32_HDF.HDF_LEFT;
                                break;
                        }
                        // now update the column format
                        SendMessage(this.col_hdrctl.Handle, W32_HDM.HDM_SETITEMW, index, ref this.col_hditem);
                    }
                }
            }
            ...
            /// </summary>
            public int Count {
                get { return SendMessage(this.col_hdrctl.Handle, W32_HDM.HDM_GETITEMCOUNT, 0, 0); }
            }
        }
        ...
        public class ColumnDataTypeCollection {
            ...
            public LVFDataType this[int index] {
                get {
                    ...
                    this.col_hditem.mask = W32_HDI.HDI_LPARAM;
                    this.col_hditem.lParam = (int) LVFDataType.String;
                    // if it is valid the lparam is updated and then returned
                    SendMessage(this.col_hdrctl.Handle, W32_HDM.HDM_GETITEMW, index, ref this.col_hditem);
                    return (LVFDataType) this.col_hditem.lParam;
                }
                set {
                    // ensure that this is a valid column
                    if (index < this.Count) {
                        ...
                        this.col_hditem.mask = W32_HDI.HDI_LPARAM;
                        this.col_hditem.lParam = (int) value;
                        SendMessage(this.col_hdrctl.Handle, W32_HDM.HDM_SETITEMW, index, ref this.col_hditem);
                    }
                }
            }
        ...
        public class ColumnNamesCollection {
            ...
            public string this[int index] {
                get {
                    ...
                    this.col_hditem.mask = W32_HDI.HDI_TEXT;
                    this.col_hditem.pszText = new string(new char[64]);
                    this.col_hditem.cchTextMax = this.col_hditem.pszText.Length;
                    // if successful the text has been retrieved and returned
                    SendMessage(this.col_hdrctl.Handle, W32_HDM.HDM_GETITEMA, index, ref this.col_hditem);
                    return this.col_hditem.pszText;
                }
                set {
                    ...
                    if (index < this.Count) {
                        ...
                        this.col_hditem.mask = W32_HDI.HDI_TEXT;
                        this.col_hditem.pszText = value;
                        this.col_hditem.cchTextMax = this.col_hditem.pszText.Length;
                        SendMessage(this.col_hdrctl.Handle, W32_HDM.HDM_SETITEMA, index, ref this.col_hditem);
                    }
                }
            }
        ...
        public class ColumnFilterCollection {
            ...
            public string this[int index] {
                get {
                    ...
                    this.col_txtflt.pszText = new string(new char[64]);
                    this.col_txtflt.cchTextMax = this.col_txtflt.pszText.Length;
                    // set the HDITEM up to request the current filter content
                    this.col_hditem.mask = W32_HDI.HDI_FILTER;
                    this.col_hditem.type = (uint) W32_HDFT.HDFT_ISSTRING;
                    // marshall memory big enough to contain a HDTEXTFILTER 
                    this.col_hditem.pvFilter = Marshal.AllocCoTaskMem(Marshal.SizeOf(this.col_txtflt));
                    // now copy the HDTEXTFILTER structure to the marshalled memory
                    Marshal.StructureToPtr(this.col_txtflt, this.col_hditem.pvFilter, false);
                    // retrieve the header filter string as non-wide string
                    SendMessage(this.col_hdrctl.Handle, W32_HDM.HDM_GETITEMA, index, ref this.col_hditem);
                    // un-marshall the memory back into the HDTEXTFILTER structure
                    this.col_txtflt =
                        (HDTEXTFILTER) Marshal.PtrToStructure(this.col_hditem.pvFilter, typeof (HDTEXTFILTER));
                    // remember to free the marshalled IntPtr memory...
                    Marshal.FreeCoTaskMem(this.col_hditem.pvFilter);
                    // return the string in the text filter area
                    return this.col_txtflt.pszText;
                }
                set {
                    ...
                    if (index < this.Count) {
                        ...
                        this.col_txtflt.pszText = value;
                        this.col_txtflt.cchTextMax = 64;
                        this.col_hditem.mask = W32_HDI.HDI_FILTER;
                        this.col_hditem.type = (uint) W32_HDFT.HDFT_ISSTRING;
                        this.col_hditem.pvFilter = Marshal.AllocCoTaskMem(Marshal.SizeOf(this.col_txtflt));
                        Marshal.StructureToPtr(this.col_txtflt, this.col_hditem.pvFilter, false);
        ...
        public class ColumnSizeInfoCollection {
            ...
            public Size this[int index] {
                get {
                    ...
                    if (index < this.Count) {
                        SendMessage(this.col_hdrctl.Handle, W32_HDM.HDM_GETITEMRECT, index, ref this.col_rectng);
                        return new Size((this.col_rectng.right - this.col_rectng.left), this.col_rectng.left);
                    }
    ...
    internal class ListViewFilterSorter : IComparer {
        ...
        private readonly FTSListView cmp_lstvew = null; // owning listview
        ...
        /// <summary>
        /// Constructor, we need the instance of the FTSListView.
        /// </summary>
        /// <param name="listview">Owner</param>
        public ListViewFilterSorter(FTSListView listview) {
            this.cmp_lstvew = listview;
        }
        ...
        public int Compare(object o1, object o2) {
            ...
            if ((o1 != null) && (o2 != null)) {
                ...
                string s1 = this.cmp_lstvew.ItemText((ListViewItem) o1, this.cmp_lstvew.SortColumn);
                string s2 = this.cmp_lstvew.ItemText((ListViewItem) o2, this.cmp_lstvew.SortColumn);
                // compare the two strings using the data type
                rz = this.cmp_lstvew.CompareData(s1, s2, this.cmp_lstvew.SortType, false);
            }
            // return +/- result depending upon sort order
            return (this.cmp_lstvew.SortOrder) ? rz : (rz*(-1));
        }
